...
//Set the directory for the folder where are all the image files (and only those files) with new names containing run and well info:
directory="C:\\Users\\elma\\Documents\\Rootsi\\RIKEN 2015\\RawRenamed";
